...
class _TermsScreenState extends State<TermsScreen> with Validations {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: defaultAppBar(text: ' Terms and Conditions'),
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Center(child: Image.asset(ImageAssets.conditions)),
              SizedBox(
